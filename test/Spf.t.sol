...
contract SpfTest is Test {
    ...
    function test_RequestSpf_EmitsEvent() public {
        ...
        inputs[2] = Spf.createOutputCiphertextParameter(4);
        ...
        expectedParams[2] = Spf.SpfParameter({metaData: 0x020401 << 232, payload: new bytes32[](0)});
    ...
    function test_RequestSpf_Parameters() public {
        ...
        inputs[2] = Spf.createOutputCiphertextParameter(4);
        inputs[3] = Spf.createOutputCiphertextArrayParameter(4, 4);
        ...
        expectedParams[2] = Spf.SpfParameter({metaData: 0x020401 << 232, payload: new bytes32[](0)});
        expectedParams[3] = Spf.SpfParameter({metaData: 0x020404 << 232, payload: new bytes32[](0)});
    ...
    function test_outputHash() public pure {
        ...
        parameters[4] = Spf.createOutputCiphertextParameter(4);
    ...
    function test_outputHashDifferentInputsDifferentHashes() public pure {
        ...
        params1[1] = Spf.createOutputCiphertextParameter(4);
        ...
        params2[1] = Spf.createOutputCiphertextParameter(4);
